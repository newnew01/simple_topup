        ...
        <div class="modal-body">
            ...
            <table class="table table-hover">
              ...
              <tr ng-repeat="data in topup_histories">
                ...
                <td><% data.number %></td>
                <td><% data.cash %></td>
                <td><% data.drawn_amount %><button class='btn btn-xs btn-default' ng-if="data.drawn_amount == null && data.status == 2" ng-click="refund(data.orderid,data.network_code)">ดึงคืน</button></td>
                <td>
